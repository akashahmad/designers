          ...
          <div>
            <div className="tech-container">
              <div className="circle-tech react-color vert-move">
                <img src={require("../../images/reactjs.png")} alt="GeeksHub-Media" />
              </div>
              <div className="circle-tech nodejs-color vert-other ">
                <img src={require("../../images/nodejs.png")} alt="GeeksHub-Media" />
              </div>
              <div className="circle-tech mysql-color vert-move">
                <img src={require("../../images/MySQL.png")} alt="GeeksHub-Media"/>
              </div>
              ...
              <div className="circle-tech gatsby-color vert-other ">
                <img src={require("../../images/gatsby.png")} alt="GeeksHub-Media" />
              </div>
              <div className="circle-tech rest-color vert-move">
                <img src={require("../../images/rest-api.png")} alt="GeeksHub-Media"/>
              </div>
              <div className="circle-tech graph-color vert-other ">
                <img src={require("../../images/graphql.png")} alt="GeeksHub-Media" />
              </div>
            </div>
          </div>
        </div>
