    ...
    return (
        <div>
            <Helmet>
                ...
                <meta
                    property="og:image"
                    content={require("../images/geekshub-black-logo.png")}/>
                ...
                <meta
                    ...
                    content="JSDvTu058M1UuhdASFVpudUNAhW8rLEJGaIVj4VmyuE"/>
                <script type="text/javascript" async>
                    {typeof document !== "undefined" && document.body.clientWidth > 991 && translator}</script>
                <script type="text/javascript" async>
                    {typeof document !== "undefined" && document.body.clientWidth < 992 && translator1}</script>
                <script
